module tiny_fabric_7x5
    ...
    (
        ...
        input  Tile_X6Y1_A_OUT_top, //EXTERNAL
        output  Tile_X6Y1_A_IN_top, //EXTERNAL
        output  Tile_X6Y1_A_EN_top, //EXTERNAL
        input  Tile_X6Y1_B_OUT_top, //EXTERNAL
        output  Tile_X6Y1_B_IN_top, //EXTERNAL
        output  Tile_X6Y1_B_EN_top, //EXTERNAL
        input  Tile_X6Y1_C_OUT_top, //EXTERNAL
        output  Tile_X6Y1_C_IN_top, //EXTERNAL
        output  Tile_X6Y1_C_EN_top, //EXTERNAL
        input  Tile_X6Y1_D_OUT_top, //EXTERNAL
        output  Tile_X6Y1_D_IN_top, //EXTERNAL
        output  Tile_X6Y1_D_EN_top, //EXTERNAL
        ...
        input  Tile_X6Y3_A_OUT_top, //EXTERNAL
        output  Tile_X6Y3_A_IN_top, //EXTERNAL
        output  Tile_X6Y3_A_EN_top, //EXTERNAL
        input  Tile_X6Y3_B_OUT_top, //EXTERNAL
        output  Tile_X6Y3_B_IN_top, //EXTERNAL
        output  Tile_X6Y3_B_EN_top, //EXTERNAL
        input  Tile_X6Y3_C_OUT_top, //EXTERNAL
        output  Tile_X6Y3_C_IN_top, //EXTERNAL
        output  Tile_X6Y3_C_EN_top, //EXTERNAL
        input  Tile_X6Y3_D_OUT_top, //EXTERNAL
        output  Tile_X6Y3_D_IN_top, //EXTERNAL
        output  Tile_X6Y3_D_EN_top, //EXTERNAL
        ...
        input  [(MaxFramesPerCol*7)-1:0] FrameStrobe //CONFIG_PORT
);
...
`endif
    ...
    .A_OUT_top(Tile_X6Y1_A_OUT_top),
    .A_IN_top(Tile_X6Y1_A_IN_top),
    .A_EN_top(Tile_X6Y1_A_EN_top),
    .B_OUT_top(Tile_X6Y1_B_OUT_top),
    .B_IN_top(Tile_X6Y1_B_IN_top),
    .B_EN_top(Tile_X6Y1_B_EN_top),
    .C_OUT_top(Tile_X6Y1_C_OUT_top),
    .C_IN_top(Tile_X6Y1_C_IN_top),
    .C_EN_top(Tile_X6Y1_C_EN_top),
    .D_OUT_top(Tile_X6Y1_D_OUT_top),
    .D_IN_top(Tile_X6Y1_D_IN_top),
    .D_EN_top(Tile_X6Y1_D_EN_top),
...
`endif
    ...
    .A_OUT_top(Tile_X6Y3_A_OUT_top),
    .A_IN_top(Tile_X6Y3_A_IN_top),
    .A_EN_top(Tile_X6Y3_A_EN_top),
    .B_OUT_top(Tile_X6Y3_B_OUT_top),
    .B_IN_top(Tile_X6Y3_B_IN_top),
    .B_EN_top(Tile_X6Y3_B_EN_top),
    .C_OUT_top(Tile_X6Y3_C_OUT_top),
    .C_IN_top(Tile_X6Y3_C_IN_top),
    .C_EN_top(Tile_X6Y3_C_EN_top),
    .D_OUT_top(Tile_X6Y3_D_OUT_top),
    .D_IN_top(Tile_X6Y3_D_IN_top),
    .D_EN_top(Tile_X6Y3_D_EN_top),
